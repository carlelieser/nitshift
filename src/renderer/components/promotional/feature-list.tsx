...
import { DonutSmall, Monitor, Schedule, WbSunny } from "mui-symbols";
	...
	return (
		<Stack sx={{ overflowX: "hidden" }} gap={2} pb={2} {...props}>
			<Alert sx={{ zIndex: 10 }} elevation={4} square={true} severity={"info"}>
				Gain access to all current and upcoming pro features on all your devices with a single license —
				forever.
			</Alert>
