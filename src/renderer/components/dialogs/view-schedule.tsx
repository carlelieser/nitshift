				...
				<TransitionGroup>
					{schedule.length === 0 ? (
						<Grow mountOnEnter={true} unmountOnExit={true}>
							<Stack alignItems={"center"} justifyContent={"center"} textAlign={"center"} p={2} spacing={2}>
								<Box
									sx={{
								...
								<Stack spacing={1}>
									...
									<Typography sx={{ opacity: 0.7 }}>Define when to adjust the brightness for your monitors</Typography>
								</Stack>
							</Stack>
						</Grow>
					) : null}
